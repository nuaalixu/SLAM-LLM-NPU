...
# decode_log=/aistor/aispeech/hpc_stor01/home/fangyangui/workingspace/github/SLAM-LLM-NPUexamples/asr_fireredasr/decode_${dataset}_${dataset_task}_${prompt_style}
