...
npu_device=1 # set device to decode on
dataset=new_test
dataset_task=asr
prompt_style=normal  # normal #instruct
encoder_name=conformer
use_peft=true # to lora llm
use_fp16=true 
pad_or_trim=true
ckpt_path=/aistor/aispeech/hpc_stor01/home/pengjing00sx/FireRedASR/pretrained_models/FireRedASR-LLM-L # fireredasr type ! checkpoint path
file=examples/asr_fireredasr/model/slam_fireredasr.py:model_factory # self-style model factory

# to do: set test dataset path
...
elif [[ $dataset == "new_test" ]]
then
    test_scp_file_path=/aistor/aispeech/hpc_stor01/home/pengjing00sx/FireRedASR/examples/wav/wav.list
    # /aistor/aispeech/hpc_stor01/group/asr/test/chn_huiyi_simulate_250318_vad_cut/ais_ul_output_dump_16000fs_1ch_20250317194243_agc_0/wav.list
    # /aistor/aispeech/hpc_stor01/group/asr/test/chn_huiyi_simulate_250318_vad_cut/ais_ul_output_dump_16000fs_1ch_20250318102110_agc_0/wav.list
    # /aistor/aispeech/hpc_stor01/group/asr/test/chn_huiyi_simulate_250318_vad_cut/ais_ul_input_dump_16000fs_1ch_20250116143927_1xh/wav.list
    # /aistor/aispeech/hpc_stor01/group/asr/test/chn_huiyi_simulate_250318_vad_cut/ais_ul_output_dump_16000fs_1ch_20250318184535_agc_0/wav.list
else
    test_scp_file_path=/aistor/aispeech/hpc_stor01/home/fangyangui/workingspace/data/${dataset}/test/
fi

get_dataset=examples/asr_fireredasr/model/slam_fireredasr.py:get_speech_testwavdataset # self-style dataset process
decode_log=examples/asr_fireredasr/decode_log/decode_${dataset}_test_demo_${dataset_task}_${prompt_style}
...
# you can add wer computation in this place
