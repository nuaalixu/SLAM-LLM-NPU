...
class WhisperWrappedEncoder:
    ...
    def load(cls, model_config):
        ...
        if model_config.get('whisper_decode', None): #if model_config.whisper_decode:
            import whisper
        ...
        if model_config.get('encoder_path_hf', None) is not None: # if model_config.encoder_path_hf is not None:
